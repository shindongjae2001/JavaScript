...
//book.published date = "2023-11";  //신텍스 에러 => 띄어쓰기 떄문에(프로퍼티 이름에 공백쓰면 에러 발생)
...
//객체 생성 시 객체 밖에서 점표기법으로 프로퍼티 이름과 값 지정가능
...
//변수에 지정된 값을 프로퍼티로 사용해야 할 경우가 있다.
//프롬프트 창으로 입력 받아 그 값을 프로퍼티로 지정하는 경우.
//이 때 생성자 함수를 객체로 정의하여 사용할 수 있다.
...
console.log("user_id1 === user_id2 : ", user1 === user2)
...
//상황에 따라 만들 심벌을 다른 곳에서 사용해야 할 경우가 있다.
...
//Symbol.keyFor() 메서드
//전역 심벌의 키를 찾는다.
console.log("Sysbol.keyFor(Phone : ",Symbol.keyFor(phone))
